...
void main() {
  group('SnackProductsResponse', () {
    ...
    test('fromJson correctly maps json to product list', () {
      ...
      final response = SnackProductsResponse.fromJson(jsonInput);
