...
void main() {
  group('MostUseProductsResponse', () {
    ...
    test('fromJson correctly maps json to product list', () {
      ...
      final response = MostUseProductsResponse.fromJson(jsonInput);
